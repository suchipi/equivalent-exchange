...
When [ParseOptions](/api/ee-types.md#parseoptions-exported-type) appears as a property on [TransmuteOptions](/api/ee-types.md#transmuteoptions-exported-type),
...
When [PrintOptions](/api/ee-types.md#printoptions-exported-type) appears as a property on [TransmuteOptions](/api/ee-types.md#transmuteoptions-exported-type),
if the parent `TransmuteOptions` has a `fileName` property, it will be
